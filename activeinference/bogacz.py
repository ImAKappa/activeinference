...
__all__ = ['possible_food_sizes', 'prior_food_size', 'priors', 'estimated_light_intensity', 'noisyness_of_estimate',
           'light_intensity_likelihood', 'possible_light_intensities', 'likelihoods', 'probs_of_possible_food_sizes',
           'hypothesis_interval_width']
